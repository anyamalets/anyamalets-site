...
const faqItems = [
  {
    ...
    answer:
      "Расстройства пищевого поведения — это психические заболевания, связанные с нарушениями питания. К ним относятся булимия, приступообразное переедание и другие типы этого расстройства. РПП часто маскируют глубокие проблемы с эмоциями и самооценкой.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text/70 mb-8">
              Ответы на вопросы о расстройствах пищевого поведения и психотерапии
            </p>
