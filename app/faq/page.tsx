...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Психотерапия — это первая линия лечения расстройств пищевого поведения. Доказательные методы — когнитивно-поведенческая терапия (КПТ) и диалектико-поведенческая терапия (DBT) — показывают хорошие результаты и входят в клинические рекомендации. Решение о назначении медикаментов принимает врач. Я работаю с психотерапией — это моя компетенция. Если вам нужна фармакологическая поддержка, мы можем координировать это с вашим врачом, но основная работа — психотерапевтическая.",
  },
  {
