...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "КПТ фокусируется на связи мыслей, эмоций и поведения. DBT учит навыкам эмоциональной регуляции и стрессоустойчивости. ACT помогает действовать в соответствии с ценностями.",
  },
  {
