...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "КПТ (когнитивно-поведенческая терапия) фокусируется на связи мыслей, эмоций и поведения. DBT (диалектическая поведенческая терапия) учит навыкам эмоциональной регуляции и стрессоустойчивости. ACT (терапия принятия и привязанности) помогает действовать в соответствии с ценностями.",
  },
  {
