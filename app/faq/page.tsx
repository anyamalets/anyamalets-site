...
const faqItems = [
  {
    ...
    answer:
      "Расстройства пищевого поведения — это психические заболевания, связанные с нарушениями питания. К ним относятся нервная нервная анорексия, нервная нервная булимия, приступообразное переедание и другие типы этого расстройства. РПП часто маскируют глубокие проблемы с эмоциями и самооценкой.",
  },
  {
  ...
  {
    question: "Чем нервная анорексия отличается от булимии?",
    answer:
      "Анорексия — это ограничение питания и потеря веса. Булимия — цикл переедания с очищением или чрезмерными физическими нагрузками. Психотерапия помогает справиться с обоими расстройствами.",
  },
  {
    question: "Как долго длится терапия РПП?",
    answer:
      "Работа с РПП обычно длится от 3 до 12 месяцев, но сроки индивидуальны и зависят от: тяжести и длительности расстройства, типа РПП (нервная анорексия, нервная булимия, переедание), наличия коморбидных расстройств. Некоторые люди видят значительное улучшение за 3-4 месяца, другим требуется полный год интенсивной работы. На первой консультации мы обсудим реалистичные сроки конкретно для вашей ситуации.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "КПТ (когнитивно-поведенческая терапия) фокусируется на связи мыслей, эмоций и поведения. DBT (диалектико-поведенческая терапия) учит навыкам эмоциональной регуляции и стрессоустойчивости. ACT (терапия принятия и привязанности) помогает действовать в соответствии с ценностями.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Первый шаг — написать. Обсудим вашу ситуацию, подход, расписание. Первая консультация — это знакомство.",
  },
  {
