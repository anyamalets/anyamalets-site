...
const faqItems = [
  {
    ...
    answer: "Расстройства пищевого поведения — это психические заболевания, связанные с нарушениями питания. К ним относятся анорексия, булимия, компульсивное переедание (BED) и другие типы расстройств."
  },
  {
    question: "Каковы первые признаки РПП?",
    answer: "Основные признаки: одержимость едой и весом, резкие изменения в весе, фиксация на весе, избегание смотреть на себя в зеркало, избегание фотографироваться, беспокойство при приёме пищи."
  },
  {
