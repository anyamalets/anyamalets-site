...
export default function About() {
  return (
    <section id="about" className="relative w-full bg-bg-beige scroll-mt-24">
      <div className="mx-auto max-w-[1200px] px-6 md:px-10 lg:px-14 py-28 md:py-36 lg:py-44">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-14 items-center">
          ...
          <div className="md:col-span-7 md:col-start-1 md:row-start-1 order-2 md:order-1 flex flex-col">
            <h2 className="text-[32px] md:text-[44px] lg:text-[56px] font-semibold text-charcoal leading-[1.1] tracking-tight" style={{ fontFamily: "var(--font-parisienne)" }}>
              Анна Малюточкина
            </h2>
