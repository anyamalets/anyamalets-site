...
const methods = [
  {
    ...
    text:
      "Часто одна и та же цепочка — мысль, чувство, еда, вина — повторяется по кругу. Мы разбираем эти круги и находим места, где можно вмешаться: чтобы поведение перестало быть на автопилоте.",
  },
  {
    tag: "ACT",
