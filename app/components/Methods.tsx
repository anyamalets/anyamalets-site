const methods = [
  ...
  {
    tag: "DBT",
    full: "диалектическая поведенческая терапия",
    title: "Что делать, когда накрывает",
    text:
      "Когда эмоции становятся слишком сильными, кажется, что выхода нет — и вы делаете что-то, о чём потом жалеете. Мы осваиваем навыки, которые помогают проживать эти моменты по-другому.",
  },
];
