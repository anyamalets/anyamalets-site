...
const quotes = [
  ...
  {
    text: 'Говори с собой так, как говорила бы с тем, кого любишь.',
    author: 'БРЕНЕ БРАУН',
  },
  {
    text: 'Ругать себя, когда вам плохо, это как кидать в себя дротики: вам не станет лучше, у вас просто будет больше ран.',
    author: 'РИК ХАНСОН',
  },
  {
    text: 'Любопытный парадокс в том, что, когда я принимаю себя таким, какой я есть, я могу меняться.',
    author: 'КАРЛ РОДЖЕРС',
  },
];
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6 md:px-10 lg:px-14">
        <div className="max-w-[900px] mx-auto">
          <h2 className="text-center text-[32px] md:text-[40px] lg:text-[44px] font-semibold text-charcoal leading-[1.15] mb-14 md:mb-20">
            Вдохновение
          </h2>
