const steps = [
  ...
  },
  {
    ...
    title: "Моё видение",
    text:
      "Рассказываю, как я вижу вашу ситуацию и с чем можно работать дальше. Без ярлыков — просто чтобы понять, что происходит и куда двигаться.",
  },
  {
    phase: "В завершение",
    title: "Что дальше",
    text:
      "Решаем, продолжаем ли работу. Если нет — это нормально. Подойти друг другу важно, и это тоже часть работы.",
  },
];
