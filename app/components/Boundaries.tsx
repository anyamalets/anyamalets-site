const items = [
  ...
  },
  {
    ...
    text:
      "Если сейчас вы в остром состоянии и нуждаетесь в медицинской помощи — сначала важно обратиться к врачу. Когда состояние стабилизируется, тогда можно начать работу со мной.",
  },
];
