        ...
        <Section title="Организационные условия">
          <div className="mt-2">
            ...
            <Field label="Длительность">
              ...
              уведомления — сессия считается проведённой.
            </Field>
            ...
            <Field label="Прекращение работы">
              ...
              Я&nbsp;со&nbsp;своей стороны тоже могу прекратить работу —
              при грубом нарушении условий с&nbsp;вашей стороны, если
              станет понятно, что нужна помощь другого специалиста,
              или&nbsp;по&nbsp;моему профессиональному решению.
              В&nbsp;этом случае я&nbsp;предупреждаю заранее, возвращаю
              оплату за&nbsp;неоказанные сессии, при возможности проводим
              завершающую сессию и&nbsp;даю рекомендации к&nbsp;коллегам
