        ...
        <Section title="Организационные условия">
          <div className="mt-2">
            ...
            <Field label="Связь между сессиями">
              Предпочтительный способ — Telegram. Переписка — про
              организационные вопросы: время, домашнее задание, материалы.
              Если мы&nbsp;не&nbsp;договорились об&nbsp;ином —
              я&nbsp;не&nbsp;отвечаю на&nbsp;содержательные вопросы
              между сессиями.
            </Field>
