...
const personLd = {
  ...
  description:
    "Психолог, работаю в доказательных подходах: когнитивно-поведенческая терапия (КПТ), терапия принятия и ответственности (ACT), диалектико-поведенческая терапия (DBT). Помогаю при расстройствах пищевого поведения и смежных темах.",
  url: SITE_URL,
