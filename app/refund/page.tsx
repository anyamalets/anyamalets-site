      ...
      <div className="mx-auto max-w-[760px] px-6 md:px-10 py-16 md:py-24">
        ...
        <Block title="Если заболели или случилось серьёзное">
          <p>
            ...
            без удержания оплаты. Если отмены становятся регулярными —
            обсудим, помогает ли&nbsp;работа в&nbsp;таком ритме сейчас.
            Терапия с&nbsp;большими перерывами теряет эффективность,
