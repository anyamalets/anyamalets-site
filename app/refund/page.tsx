  ...
  return (
    <main id="main-content" className="bg-bg text-text">
      <div className="mx-auto max-w-[760px] px-6 md:px-10 py-16 md:py-24">
        ...
        <Block title="Если у вас уважительная причина">
          <p>
            Болезнь, госпитализация, ДТП, экстренные семейные обстоятельства,
          ...
          <p>
            ...
            ли&nbsp;работа в&nbsp;таком ритме сейчас. Терапия
            с&nbsp;большими перерывами теряет эффективность,
            и&nbsp;иногда лучше сделать паузу и&nbsp;вернуться позже,
            чем&nbsp;продолжать в&nbsp;нерегулярном режиме.
          </p>
        </Block>

        <Block title="Если форс-мажор (для нас обеих)">
          <p>
            Чрезвычайные ситуации, военные действия, действия властей,
            масштабные аварии связи и&nbsp;другие обстоятельства непреодолимой
            силы. Сессия переносится, оплата возвращается полностью.
          </p>
        </Block>
        ...
        <Block title="Если отменяю я менее чем за 24 часа">
          ...
          <p>
            При моей болезни или&nbsp;форс-мажоре — только возврат либо
            перенос, без дополнительной компенсации.
          </p>
        </Block>
